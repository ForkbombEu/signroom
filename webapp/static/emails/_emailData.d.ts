type EmailData = {
    ...
    "flow-update_generic-update": [
        ...
        "Cryptography",
        "Expiration",
        "UpdatedAuthTemplateName",
        "CredentialTemplateDescription",
        "UpdatedCredentialTemplateName",
        "CredentialTemplateDescription",
        "AuthServer",
        "CredentialIssuer",
        "IsPublic",
    ...
    "verification-flow-update_microservices": [
        "UserName",
        "FlowName",
        "OrganizationName",
        "Editor",
    ...
    "verification-flow-update_templates": [
        "username",
        "FlowName",
        "OrganizationName",
        "Editor",
