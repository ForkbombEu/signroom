...
export type CrudExampleResponse<Texpand = unknown> = Required<CrudExampleRecord> &
	BaseSystemFields<Texpand>;
export type FeaturesResponse<TenvVariables = unknown, Texpand = unknown> = Required<
	FeaturesRecord<TenvVariables>
> &
	BaseSystemFields<Texpand>;
export type FoldersResponse<Texpand = unknown> = Required<FoldersRecord> &
	BaseSystemFields<Texpand>;
export type HooksResponse<Texpand = unknown> = Required<HooksRecord> & BaseSystemFields<Texpand>;
export type SignaturesResponse<Tsigned_file = unknown, Texpand = unknown> = Required<
	SignaturesRecord<Tsigned_file>
> &
	BaseSystemFields<Texpand>;
